/*!
* Imported from SiLabs driver files and modified
*
...
#ifndef _SI4463_DEFS_H_
#define _SI4463_DEFS_H_
...
struct ZETARF_PACKED si446x_reply_PART_INFO_map {
        uint8_t CHIPREV;
        uint16_t PART;
        uint8_t PBUILD;
        uint16_t ID;
...
struct ZETARF_PACKED si446x_reply_PACKET_INFO_map {
        uint16_t LENGTH;
};

struct ZETARF_PACKED si446x_reply_GET_MODEM_STATUS_map {
        uint8_t MODEM_PEND;
        uint8_t MODEM_STATUS;
        uint8_t CURR_RSSI;
        uint8_t LATCH_RSSI;
...
struct ZETARF_PACKED si446x_reply_GET_ADC_READING_map {
        uint16_t GPIO_ADC;
...
struct EZRadioReply_Si446x {
// Pretty names for reply packets
typedef si446x_reply_PART_INFO_map              PartInfo;
typedef si446x_reply_FUNC_INFO_map              FuncInfo;
typedef si446x_reply_GET_PROPERTY_map           Properties;
typedef si446x_reply_GPIO_PIN_CFG_map           GpioPinConfig;
typedef si446x_reply_FIFO_INFO_map              FifoInfo;
typedef si446x_reply_GET_INT_STATUS_map         InterruptStatus;
typedef si446x_reply_REQUEST_DEVICE_STATE_map   DeviceState;
typedef si446x_reply_READ_CMD_BUFF_map          CommandBuffer;

typedef si446x_reply_FRR_A_READ_map             FrrA;
typedef si446x_reply_FRR_B_READ_map             FrrB;
typedef si446x_reply_FRR_C_READ_map             FrrC;
typedef si446x_reply_FRR_D_READ_map             FrrD;

typedef si446x_reply_IRCAL_MANUAL_map           IRCal;
typedef si446x_reply_PACKET_INFO_map            PacketInfo;
typedef si446x_reply_GET_MODEM_STATUS_map       ModemStatus;
typedef si446x_reply_READ_RX_FIFO_map           ReadRxFifo;
typedef si446x_reply_GET_ADC_READING_map        AdcReadings;
typedef si446x_reply_GET_PH_STATUS_map          PhStatus;
typedef si446x_reply_GET_CHIP_STATUS_map        ChipStatus;

typedef si446x_cmd_reply_union                  CommandReplyUnion;
};
...
// Properties
// Relevant to parts: Si4460_revC2A, Si4461_revC2A, Si4463_revC2A
