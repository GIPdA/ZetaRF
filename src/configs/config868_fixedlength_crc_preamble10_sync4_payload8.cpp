...
#include "config868_fixedlength_crc_preamble10_sync4_payload8.hpp"
...
const uint8_t Config868_FixedLength_CRC_Preamble10_Sync4_Payload8::RadioConfigurationDataArray[]
{
    0x07, RF_POWER_UP, \
