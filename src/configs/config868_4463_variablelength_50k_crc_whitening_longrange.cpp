...
// MOD_type: 3    Rsymb(sps): 50000    Fdev(Hz): 20000    RXBW(Hz): 150000    Manchester: 1    AFC_en: 1    Rsymb_error: 0.0    Chip-Version: 2
// RF Freq.(MHz): 868    API_TC: 29    fhst: 250000    inputBW: 0    BERT: 0    RAW_dout: 0    D_source: 0    Hi_pfm_div: 1
//
// # RX IF frequency is  -468750 Hz
// # WB filter 2 (BW = 103.06 kHz);  NB-filter 3 (BW = 92.61 kHz)
//
...
*/
#define RF_GPIO_PIN_CFG 0x13, 0x09, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
...
*/
#define RF_INT_CTL_ENABLE_2 0x11, 0x01, 0x02, 0x00, 0x05, 0x30
...
*/
#define RF_INT_CTL_CHIP_ENABLE_1 0x11, 0x01, 0x01, 0x03, 0x2C
...
*/
#define RF_FRR_CTL_A_MODE_4 0x11, 0x02, 0x04, 0x00, 0x09, 0x0A, 0x04, 0x08
...
*/
#define RF_PREAMBLE_TX_LENGTH_9 0x11, 0x10, 0x09, 0x00, 0x30, 0x10, 0x00, 0x0F, 0x3D, 0x00, 0x00, 0x00, 0x00
...
*/
#define RF_SYNC_CONFIG_5 0x11, 0x11, 0x05, 0x00, 0x07, 0xB4, 0x2B, 0x4B, 0xB2
...
*/
#define RF_PKT_LEN_12 0x11, 0x12, 0x0C, 0x08, 0x0A, 0x01, 0x00, 0x30, 0x30, 0x00, 0x01, 0x07, 0x82, 0x00, 0x20, 0x03
...
*/
#define RF_MODEM_MOD_TYPE_12 0x11, 0x20, 0x0C, 0x00, 0x03, 0x80, 0x07, 0x0F, 0x42, 0x40, 0x09, 0xC9, 0xC3, 0x80, 0x00, 0x02
...
*/
#define RF_MODEM_AFC_GEAR_7 0x11, 0x20, 0x07, 0x2C, 0x00, 0x12, 0xC0, 0xDA, 0x01, 0xCC, 0xE0
...
*/
#define RF_MODEM_AGC_WINDOW_SIZE_9 0x11, 0x20, 0x09, 0x38, 0x11, 0x10, 0x10, 0x00, 0x1A, 0x33, 0x33, 0x00, 0x28
...
*/
#define RF_MODEM_CHFLT_RX1_CHFLT_COE1_7_0_12 0x11, 0x21, 0x0C, 0x0C, 0x03, 0x00, 0x15, 0xFF, 0x00, 0x00, 0xCC, 0xA1, 0x30, 0xA0, 0x21, 0xD1
...
const uint8_t Config868_Si4463_VariableLength_50kbps_CRC_Whitening_LongRange::RadioConfigurationDataArray[] {
    0x07, RF_POWER_UP, \
